...
const NavbarDefault = [
  {
    id: uuid(),
    menuitem: "1:1 session",
    link: "#",
    children: [
      {
        id: uuid(),
        menuitem: "Book a session",
        link: "/one-to-one-session/book",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        id: uuid(),
        menuitem: "Course Landing Page",
        link: "/course/course-landing-page#",
      },
      {
        id: uuid(),
        menuitem: "Quiz Zone",
        link: "/quiz-section/QuizZone",
      },
      {
        id: uuid(),
        menuitem: "True & False",
        link: "/quiz-section/TrueFalse",
      },
      {
        id: uuid(),
        menuitem: "Self Challenge",
        link: "/quiz-section/SelfChallenge",
      },
      {
        id: uuid(),
      ...
      {
        id: uuid(),
        menuitem: "1 vs 1 Battle",
        link: "/quiz-section/OneVsOneBattle",
      },
      {
        id: uuid(),
        menuitem: "Group Battle",
        link: "/quiz-section/GroupBattle",
      },
      {
        id: uuid(),
        menuitem: "Exam",
        link: "/quiz-section/Exam",
      },
    ],
  },
  {
