...
const NavbarDefault = [
  ...
  },
  {
    ...
    children: [
      {
        id: uuid(),
        link: "/dashboard/components/accordions",
        menuitem: "Accordions",
      },
      ...
      {
        id: uuid(),
        link: "/dashboard/components/breadcrumbs",
      ...
      {
        id: uuid(),
        link: "/dashboard/components/button-group",
        menuitem: "ButtonGroup",
      },
      { id: uuid(), link: "/dashboard/components/cards", menuitem: "Cards" },
      {
        id: uuid(),
        link: "/dashboard/components/carousels",
        menuitem: "Carousel",
      },
      {
        id: uuid(),
        link: "/dashboard/components/close-button",
        menuitem: "Close Button",
      },
      {
        id: uuid(),
        link: "/dashboard/components/collapse",
        menuitem: "Collapse",
      },
      {
        id: uuid(),
      ...
      {
        id: uuid(),
        link: "/dashboard/components/list-group",
        menuitem: "Listgroup",
      },
      ...
      {
        id: uuid(),
        link: "/dashboard/components/offcanvas",
        menuitem: "Offcanvas",
      },
      {
        id: uuid(),
        link: "/dashboard/components/overlays",
        menuitem: "Overlays",
      },
      {
        id: uuid(),
        link: "/dashboard/components/pagination",
        menuitem: "Pagination",
      },
      {
        id: uuid(),
        link: "/dashboard/components/popovers",
        menuitem: "Popovers",
      },
      {
        id: uuid(),
      ...
      {
        id: uuid(),
        link: "/dashboard/components/spinners",
        menuitem: "Spinners",
      },
