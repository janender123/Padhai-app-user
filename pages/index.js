  ...
  return (
    <Fragment>
      ...
      <div style={{ padding: isSmallScreen ? "10px" : "" }}>
        ...
        <section name="all boards and exams-1">
          <Container style={{ marginTop: "30px" }}>
            ...
            <Row className="align-items-center g-0">
              ...
              <Col xl={5} lg={6} md={12}>
                <p
                  style={{ color: "#26252f", fontSize: "x-large" }}
                  className="text-dark mb-4 lead"
                >
                  Your learning needs are unique and we do everything to ensure
                  that they are met.
                </p>
                <p style={{ fontSize: "initial" }} className="text-dark">
                  Students can chart their own path by creating customised{" "}
                  syllabus that helps them attain their learning goals. With
                  over 120,000 syllabus combinations at their learning was never
                  so easy.
                </p>
              </Col>
            </Row>
        ...
        <section
          name="All Boards and Exams-2"
          className="py-8 py-lg-8 bg-light"
        >
          <Container>
            <Row>
                ...
                <Row className="text-center">
                  <Col md={12} className="px-lg-10 mb-8 ">
                    ...
                    <p style={{ fontWeight: "bold" }} className="mb-0 fs-4">
                      Select a goal and we will show you relevant courses for
                      it!
                    </p>
                  </Col>
                </Row>
              ...
              <Col lg={6} sm={6} className="mb-6 mb-lg-0">
                <div className="">
                  ...
                  >
                    ...
                    help of Treasures, <br /> brief summary of a topic, and
                    Custom <br /> Module that is designed to enable you <br />{" "}
                    to practice what and how you want.
                  </p>
                </div>
              </Col>
              <Col lg={6} sm={6} className="d-flex justify-content-center">
              ...
              <Col lg={6} sm={6} className="mb-6 mb-lg-0">
                <div className="">
                  ...
                  <p
                    ...
                    style={{ fontSize: "initial" }}
                  >
                    Leverage our rank analysis to monitor <br /> your
                    preparation journey and growth <br /> trajectory and utilize
                    our detailed report <br /> to enhance your performance.
                  </p>
                </div>
              </Col>
            </Row>
        ...
        <section name="personalised-classes" className="py-lg-16 py-8 bg-white">
          <Container>
            <Row className="align-items-center">
              <Col lg={6} sm={6} className="mb-6 mb-lg-0">
                <div className="">
                  ...
                  <p
                    ...
                    style={{ fontSize: "initial" }}
                  >
                    Our experts will design a course plan that is specific to
                    your needs, which will be taught through private classes and
