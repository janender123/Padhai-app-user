            ...
            <Row>
              ...
              >
                <div className="mb-5">
                  ...
                  <p>
                    Your primary focus will be development of all server-side
                    logic, definition and maintenance of the central database,
                    and ensuring high performance and responsiveness to requests
                    from the front-end.
                  </p>
                  <p>
                    You will also be responsible for integrating the front-end
                    elements built by your co-workers into the application.
                    Therefore, a basic understanding of front-end technologies
                  ...
                  <div className="mt-8">
                    ...
                    <div className="mt-4">
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li className="d-flex mb-4 ">
                          <i className="fe fe-check-circle me-2 text-primary  mt-1"></i>
                          Ability to integrate multiple data sources and
                  ...
                  <div className="mt-8">
                    ...
                    <div className="mt-4">
                      ...
                      <ul className="list-unstyled">
                        ...
                        <li className="d-flex mb-4 ">
                          <i className="fe fe-check-circle me-2 text-primary mt-1"></i>{" "}
                          A highly skilled and dedicated team that is fun to
                          work with
                        </li>
                        <li className="d-flex mb-4 ">
                          <i className="fe fe-check-circle me-2 text-primary  mt-1"></i>{" "}
                          Remote work – We are a diverse and distributed team
                          that uses Slack, Zoom, Notion and other tools to stay
                          connected
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="mt-4 ">
                      ...
                      <p className="mb-4">
                        ...
                        Operate with high integrity and choose what&apos;s right
                        over what&apos;s easy. Be transparent as a company and
                        with each other.
                      </p>
                      <p className="mb-4">
                        <span className="text-dark fw-bold">
                        ...
                        empathy, and respect. Start from a presumption of
                        positive intent.
                      </p>
                      <p className="mb-4">
                        <span className="text-dark fw-bold">
                        ...
                        Support and encourage each other. Seek opportunities for
                        growth
                      </p>
                      <p>
                        We are hiring in the United States, Canada, Ireland, and
                        the United Kingdom, and are interested in every
                        qualified candidate who is eligible to work in these
                        regions without employment visa sponsorship.
                      </p>
                      <p>
                        Please refer to the position specific location
                        requirements listed under the location section of the
                        job description.
                      </p>
                    </div>
                  </div>
