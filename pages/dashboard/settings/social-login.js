      ...
      <Row>
        <Col xl={6} lg={12} md={12}>
          <Card className="mb-4">
            <Card.Header className="d-flex align-items-center justify-content-between">
              <h4 className="mb-0">
                <Icon path={mdiFacebook} size={1} color="#3c65c4" /> Facebook
                Login Settings
              </h4>
              <Form>
                <Form.Check
        ...
        <Col xl={6} lg={12} md={12}>
          <Card className="mb-4">
            <Card.Header className="d-flex align-items-center justify-content-between">
              <h4 className="mb-0">
                <Icon path={mdiTwitter} size={1} color="#3c65c4" /> Twitter
                Login Settings
              </h4>
              <Form>
                <Form.Check
        ...
        <Col xl={6} lg={12} md={12}>
          <Card className="mb-4">
            <Card.Header className="d-flex align-items-center justify-content-between">
              <h4 className="mb-0">
                <Icon path={mdiCog} size={1} color="#3c65c4" /> Google Login
                Settings
              </h4>
              <Form>
                <Form.Check
        ...
        <Col xl={6} lg={12} md={12}>
          <Card className="mb-4">
            <Card.Header className="d-flex align-items-center justify-content-between">
              <h4 className="mb-0">
                <Icon path={mdiLinkedin} size={1} color="#3c65c4" /> LinkedIn
                Login API Settings
              </h4>
              <Form>
                <Form.Check
